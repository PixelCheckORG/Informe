...
|-------------------------|-------------------------|------------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | <br>**TB1:** Adrián Enrique Jesús Palma presentó el **Startup Profile**, los **perfiles del equipo**, el **Solution Profile**, la identificación de antecedentes y problemática, así como la aplicación del **Lean UX Process** (problem statements, assumptions, hypothesis statements, Lean UX Canvas). Además, se comunicó el **segmento objetivo** y el prototipo **MVP Web** de la aplicación. | En TB1, Adrián Enrique Jesús Palma logró transmitir de manera clara los resultados del diagnóstico y diseño de la solución, articulando el proceso de ingeniería con un lenguaje accesible a diferentes públicos. La exposición permitió mostrar tanto el contexto como el valor de la propuesta, cumpliendo con el logro del curso y con el Student Outcome 3 de ABET en comunicación oral. |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | <br>**TB1:** Adrián Enrique Jesús Palma elaboró el documento con el **Startup Profile**, **Solution Profile**, análisis de antecedentes, problemática, aplicación completa del **Lean UX Process**, el **Canvas de modelo de negocio** y la descripción del **MVP Web**. | En TB1, Adrián Enrique Jesús Palma demostró su capacidad de comunicación escrita al documentar de manera ordenada, objetiva y técnica el proceso de diseño y desarrollo inicial de la solución. Los entregables escritos facilitaron la comprensión tanto del problema como de la propuesta de valor, evidenciando la habilidad para comunicar resultados de ingeniería a públicos con diferentes especialidades y niveles. |
