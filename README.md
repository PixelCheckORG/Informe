...
|-------------------------|-------------------------|------------------|
| Comunica oralmente sus ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | <br>**TB1:** Yo, Adrián Enrique Jesús Palma Obispo, presenté el **Startup Profile**, los **perfiles de los integrantes del equipo**, el **Solution Profile**, la identificación de antecedentes y problemática, además de aplicar el **Lean UX Process** (problem statements, assumptions, hypothesis statements y Lean UX Canvas). También expuse el **segmento objetivo** y el prototipo **MVP Web** de la aplicación. | En TB1 demostré mi capacidad de comunicar de forma oral los resultados obtenidos y el proceso seguido. Logré explicar con claridad y objetividad el diagnóstico, la problemática y la propuesta de solución, adaptando el lenguaje a diferentes audiencias. Con esto evidencié mi competencia en el logro del curso y en el **Student Outcome 3 de ABET**, relacionado con la comunicación oral efectiva. |
| Comunica en forma escrita ideas y/o resultados con objetividad a público de diferentes especialidades y niveles jerárquicos, en el marco del desarrollo de un proyecto en ingeniería. | <br>**TB1:** Yo, Adrián Enrique Jesús Palma Obispo, elaboré el informe que incluyó el **Startup Profile**, el **Solution Profile**, los antecedentes y problemática, la aplicación del **Lean UX Process** completo, el **Canvas de modelo de negocio** y la descripción del **MVP Web**. | En TB1 demostré mi capacidad de comunicación escrita al documentar de manera estructurada y objetiva el proceso de diseño y validación inicial de la solución. Logré transmitir de forma clara tanto el problema identificado como la propuesta planteada, haciendo que los resultados fueran comprensibles para públicos con distintos niveles de especialización. Con ello, evidencié mi aporte al logro del curso y al **Student Outcome 3 de ABET**, en su dimensión escrita. |
